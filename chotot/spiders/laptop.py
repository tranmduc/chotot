...
class LaptopSpider(scrapy.Spider):
    name = 'laptop'
    start_urls = ['http://www.chotot.com/toan-quoc/mua-ban-laptop/']
    custom_settings = {'FEED_URI': "output/chotot_laptop_%(time)s.csv",
                       'FEED_FORMAT': 'csv'}
    ...
    def parse(self, response):
        ...
        while (next_page_number < 3):
            absolute_next_page_url = 'https://www.chotot.com/toan-quoc/mua-ban-laptop?page=' + str(
                next_page_number)
